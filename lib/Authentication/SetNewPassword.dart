...
class _SetnewpasswordScreenState extends State<SetnewpasswordScreen> {
  ...
  void _validateFields() {
    setState(() {
      ...
      validateConfirmPassword = confirmpassword.text != password.text
          ? "Please entered password not match with above."
          : "";
  ...
  Future<void> SetnewPasswordApi() async {
    var res =
        await Userapi.updatePassword(widget.email, password.text, context);
    if (res == true) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            appBar: AppBar(
              backgroundColor:
                  primaryColor, // Set the background color of the AppBar
              leading: IconButton(
