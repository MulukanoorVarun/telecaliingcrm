    ...
    GoRouter(initialLocation: '/', navigatorKey: navigatorKey, routes: [
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return buildSlideTransitionPage(UpDateLeadScreen(ID: id,name:name ,remarks:remarks), state);
        },
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return buildSlideTransitionPage(Callhistoryscreen(date: date, type: type), state);
        },
      ),
      GoRoute(
        path: '/add_lead',
