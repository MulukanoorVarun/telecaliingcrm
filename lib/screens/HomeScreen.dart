...
//       _saveState(); // Save state when app goes to background
//     } else if (state == AppLifecycleState.resumed) {
//       _restoreState(); // Restore state when app resumes
//     }
//   }
//
...
//               .toList(),
//         }));
//     debugPrint('Saved state: $currentIndex, $isCalling, $isPaused');
//   }
//
//   Future<void> _restoreState() async {
//     final stateJson = await PreferenceService().getString('homescreen_state');
//     if (stateJson != null) {
...
//           phoneNumbers = (state['phoneNumbers'] as List)
//               .map((e) => MobileNumbers(
//                     id: e['id'],
//                     name: e['name'],
//                     number: e['number'],
...
//         }
//       });
//       debugPrint('Restored state: $currentIndex, $isCalling, $isPaused');
//     }
//   }
//
//   // Initialize the phone state listener
